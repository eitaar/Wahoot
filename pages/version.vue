<template>
    ...
    <div id="textWrapper" ref="textWrapper">
        ...
        <ReleasenoteIndev20240912 class="text" v-show="page==2"/>
        <ReleasenoteIndev20240805 class="text" v-show="page == 3"/>
        <ReleasenoteIndev20240803 class="text" v-show="page==4" />
        <ReleasenoteIndev20240802 class="text" v-show="page==5"/>
    </div>
